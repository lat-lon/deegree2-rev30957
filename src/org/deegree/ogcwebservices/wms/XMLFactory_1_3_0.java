//$HeadURL: https://scm.wald.intevation.org/svn/deegree/base/trunk/src/org/deegree/ogcwebservices/wms/XMLFactory_1_3_0.java $
/*----------------------------------------------------------------------------
 ...
 *
 * @version $Revision: 21334 $, $Date: 2009-12-09 11:52:08 +0100 (Mi, 09. Dez 2009) $
 */
...
public class XMLFactory_1_3_0 extends XMLFactory {
    ...
    protected static void appendDimension( Element root, Dimension dim ) {
        Element dimNode = XMLTools.appendElement( root, WMSNS, PWMS + "Dimension", dim.getValues() );
